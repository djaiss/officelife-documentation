...
Team members and administrators can delete an entry that was previously created.
...
<div class="rules">
  <h4>Rules</h4>
  <ul>
    <li>An entry can be deleted by someone with either <a href="/docs/understanding-roles">the HR or administrator role</a>, or someone who is part of the team.</li>
  </ul>
</div>