...
#### Approval by the manager {#approval-by-the-manager}
...
#### Approval by the accounting department {#approval-by-the-accounting-department}
...
## Who can manage expenses: accountants {#who-can-manage-expenses}
